...
const InteractiveCard = forwardRef<HTMLDivElement, InteractiveCardProps>(
  ({ 
    ...
    const variants = {
      ...
      interactive: 'card-interactive bg-background border border-border cursor-pointer',
      expandable: 'card-expandable bg-background border border-border cursor-pointer',
    };
    ...
    const interactiveClasses = clickable ? 'cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2' : '';
